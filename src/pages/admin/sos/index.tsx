    ...
    >
            ...
            <h1 className="text-2xl lg:text-3xl font-extrabold tracking-tight text-white flex items-center gap-3">
              ...
              {activeCount > 0 && (
                <span className="px-3 py-1 bg-red-600 text-white rounded-full text-xs font-bold animate-bounce">
                  {activeCount} {t('sos.needRescue')}
                </span>
              )}
            </h1>
            <p className="text-sm text-slate-400 mt-1">
              {t('sos.centerSubtitle')}
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-2 bg-slate-900/60 p-1.5 rounded-2xl border border-slate-800 w-fit">
          ...
          >
            {t('sos.allSignals')} ({paginationMeta.totalItems})
          </button>
          <button
            onClick={() => {
        ...
        <div className="flex items-center gap-3 text-xs text-slate-400">
          ...
          >
            <option value={6}>6 {t('sos.perPage')}</option>
            <option value={12}>12 {t('sos.perPage')}</option>
            <option value={24}>24 {t('sos.perPage')}</option>
          </select>
        </div>
      </div>
      ...
      {loading ? (
        <div className="p-16 text-center text-slate-400 space-y-3">
          ...
          <p className="text-sm font-medium">{t('sos.loadingData')}</p>
        </div>
      ) : alerts.length === 0 ? (
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    >
                      ...
                      <span>
                        {isActive
                          ? t('sos.urgentUnresolved')
                          : t('sos.dispatchRescue')}
                      </span>
                    </span>
                  ...
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center gap-3 text-slate-200">
                      ...
                      <span className="text-xs font-bold">
                        {alert.user_name || t('sos.noCaptainName')}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center gap-3 text-slate-200">
                      ...
                      <span className="text-xs">
                        {alert.user_phone || t('sos.noPhone')}
                      </span>
                    </div>
          ...
          <div className="bg-slate-900 border border-slate-700 rounded-3xl p-6 max-w-md w-full shadow-2xl space-y-4 text-slate-200">
            <div className="flex items-center gap-3 text-red-400">
              ...
              <h3 className="font-extrabold text-white text-lg">
                {t('sos.confirmDeleteTitle')}
              </h3>
            </div>

            <p className="text-xs text-slate-300 leading-relaxed bg-slate-950 p-4 rounded-xl border border-slate-800">
              {t('sos.confirmDeleteDesc')}
            </p>
